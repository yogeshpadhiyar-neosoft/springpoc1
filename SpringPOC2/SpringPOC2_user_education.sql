...
CREATE TABLE `user_education` (
  `user_education_id` bigint(20) NOT NULL AUTO_INCREMENT,
  ...
  `uni_passing_year` int(11) NOT NULL,
  `university_name` varchar(255) DEFAULT NULL,
  `university_percentage` float NOT NULL,
  `user_master_user_id` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`user_education_id`),
  KEY `FKjg6hvddhe296nak6165sd0b75` (`user_master_user_id`),
  CONSTRAINT `FKjg6hvddhe296nak6165sd0b75` FOREIGN KEY (`user_master_user_id`) REFERENCES `user_master` (`user_id`)
...
INSERT INTO `user_education` VALUES (1,'Gujarat',2016,82,'Gujarat',2014,80,2020,'GTU',85.65,1),(2,'Gujarat',2016,82,'Gujarat',2014,80,2020,'GTU',85.65,2),(3,'Gujarat',2016,82,'Gujarat',2014,80,2020,'GTU',85.65,3);
